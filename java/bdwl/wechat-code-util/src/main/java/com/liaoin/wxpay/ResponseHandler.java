...
import com.liaoin.wxpay.util.TenpayUtil;
...
public class ResponseHandler {
	 ...
	 * @return boolean
	 */
	public boolean isTenpaySign(Map<String,String> parameters) {
		...
		String sign = MD5Util.MD5Encode(sb.toString(), "iso8859-1").toLowerCase();
		String sign2 = MD5Util.MD5Encode(sb.toString(), enc).toLowerCase();
