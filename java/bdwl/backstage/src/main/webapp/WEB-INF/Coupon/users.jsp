...
<div class="wrap js-check-wrap">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">优惠券赠送</a></li>
	</ul>
	<form class="well form-search" action="<%=request.getContextPath()%>/Coupon/users">
		关键字：
		...
		<table class="table table-hover table-bordered table-list" id="menus-table">
			...
			<c:forEach items="${pageResult.list}" var="list" varStatus="index">
				<tr>
					...
					<td>${list.balance}</td>
					<td>
						<a href="<%=request.getContextPath()%>/Coupon/sendToUser?weiXinUserId=${list.id}&couponId=${couponId}" data-msg="确定要赠送吗？" class="js-ajax-delete">赠送</a>
					</td>
				</tr>
			</c:forEach>
			</tbody>
