	...
	<form method="post" class="form-horizontal js-ajax-forms" action="<%=request.getContextPath()%>/Role/post">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="introduce" rows="2" cols="20" id="introduce" class="inputtext" style="height: 100px; width: 500px;"></textarea>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<c:forEach items="${roleStatusLists}" var="roleStatusList">
						<label class="radio inline" for="active_true${roleStatusList}">
							<input type="radio" name="roleStatus" value="${roleStatusList}" checked id="active_true${roleStatusList}" />${roleStatusList.name}
						</label>
					</c:forEach>
				</div>
			</div>
